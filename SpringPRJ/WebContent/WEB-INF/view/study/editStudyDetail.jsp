        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                    ...
                    <form action="/study/doEditStudyDetail.do" method="post">
								...
								<div class="col-lg-11 col-md-10 col-sm-10 col-xs-12">
									<div class="form-group">
										<div class="nk-int-st cmp-int-in cmp-email-over">
											<input type="text" value="<%=nvl(rDTO.getPost_title()) %>" name="post_title" class="form-control" placeholder="제목을 입력 하십시오." />
										</div>
									</div>
								</div>
							</div>
						<br>
                        <textarea name="post_content" class="form-control" rows="5" placeholder="내용을 입력 하십시오."><%=nvl(rDTO.getPost_content()) %></textarea>
                        <input name="post_no" value="<%=nvl(rDTO.getPost_no()) %>" hidden="hidden">
                        <br>
                        ...
                        <div class="vw-ml-action-ls text-right mg-t-20">
                            <div class="btn-group ib-btn-gp active-hook nk-email-inbox">
                                <button type="submit" class="btn btn-default btn-sm waves-effect"><i class="notika-icon notika-next"></i>수정하기</button>
                        </div>
                    </div>
                </div>
                </form>
