  ...
  $( document ).ready( function() {
	    	...
	    	console.log($(this).val());
	    		...
	    		$.ajax({
	                ...
	                success: function(data){
	                	console.log(data);
	                	if(data.confirm === "OK"){
	                		$('#email_msg').html('<i style="color: green"> 사용가능</i>');
	                	} else {
	                		$('#email_msg').html('<i style="color: red" >사용불가능</i>');
	                	}
	                },
    ...
    function doRegUserCheck(){
    	...
    	if(email.value!="" && user_name.value!="" && password.value!=""){
    		var loginForm = document.registerForm;
    		loginForm.submit();
    	}
    }
        ...
        <div class="nk-block" id="l-register">
          <form name="registerForm" action="/user/register.do"  method="post">
            ...
            <div class="nk-navigation rg-ic-stl">
                <a href="#" data-ma-action="nk-login-switch" data-ma-block="#l-login" onclick="doRegUserCheck()"><i class="notika-icon notika-right-arrow"></i> <span>Sign in</span></a>
                <a href="" data-ma-action="nk-login-switch" data-ma-block="#l-forget-password"><i>?</i> <span>Forgot Password</span></a>
            </div>
        </div>
