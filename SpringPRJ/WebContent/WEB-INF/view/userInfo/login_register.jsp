							...
							$.ajax({
										...
										success : function(data) {
											...
											if (data.confirm === "OK") {
												$('#email_msg')
														.html(
																'<i style="color: green"> 사용가능</i>');
											} else {
												$('#email_msg')
														.html(
																'<i style="color: red" >사용불가능</i>');
											}
										},
...
<body>
    ...
    <div class="login-content">
        ...
        <div class="nk-block toggled" id="l-login">
         <form name="LoginForm" action="/user/getUserLoginCheck.do"  method="post">
            <div class="nk-form">
                ...
                <a href="#" data-ma-block="#l-register" id="doLogin" class="btn btn-login btn-success btn-float"><i class="notika-icon notika-right-arrow right-arrow-ant" ></i></a>
            </div>
            </form>
        ...
        <div class="nk-block" id="l-register">
          <form name="registerForm" action="/user/register.do"  method="post">
            ...
            <div class="nk-navigation rg-ic-stl">
                <a href="#" data-ma-action="nk-login-switch" onclick="doRegUserCheck()" data-ma-block="#l-login"><i class="notika-icon notika-right-arrow"></i> <span>Sign in</span></a>
                <a href="" data-ma-action="nk-login-switch" data-ma-block="#l-forget-password"><i>?</i> <span>Forgot Password</span></a>
            </div>
        </div>
