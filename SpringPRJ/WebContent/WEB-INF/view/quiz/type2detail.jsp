        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="a">
                    ...
                    <h4>모션인식을 통해 수화를 직접해보세요 </h4><br><br>
                       	<canvas id="canvas"></canvas>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                    <div class="data-map-single sm-res-mg-t-30" style="height:510px;text-align: center; margin: 0auto;">
                    <h2>문장을 모션인식하면 이곳에 문장히 하나씩 드러납니다 </h2><br><br>
                     <canvas id="myChart" style="text-align: center; "></canvas>
                     
                    <div class="textRevealContainer">
                    <div class="textReveal rotateY">
                    <div class="div1"><h1><%=rDTO.getDiv_one()%></h1> </div><br><br>
                    <div class="div2"><h1> <%=rDTO.getDiv_two()%></h1></div><br><br>
                    <div class="div3"><h1><%=rDTO.getDiv_three()%></h1></div> <br><br>
                    </div>
                    </div>
                    
                    <div >
                        <button id="cha" class="btn btn-default btn-icon-notika waves-effect" OnClick="location.href ='/quiz/type2.do'">
