					...
					<div class="row">
						<div class="col-md-6" OnClick="location.href ='/quiz/type1.do'" style="cursor:pointer;">
							<div class="card card-1">
								<h3>단어풀이</h3><br><br>
								<p>A curated set of ES5/ES6/TypeScript wrappers for plugins
									to easily add any native functionality to your Ionic apps.</p>
							</div>
						</div>
						...
						<div class="col-md-6" OnClick="location.href ='/quiz/type2.do'">
							<div class="card card-2">
								<h3>문장풀이</h3><br><br>
								<p>Tabs, buttons, inputs, lists, cards, and more! A
									comprehensive library of mobile UI components, ready to godddddddddddddd.</p>
							</div>
						</div>
						<br>
