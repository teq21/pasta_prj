...
.filledbar {
	...
	background: linear-gradient(90deg, rgba(0, 154, 217, 1) 0%,
		rgba(217, 147, 0, 1) 65%, rgba(255, 186, 0, 1) 100%);
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div style="text-align: center;">
						<%
							for (QuizDTO e : res) {
						%>
						<div class="container1" style="  display:inline-block;" onclick="location.href='/quiz/type1detail.do?sign_name=<%=e.getSign_name()%>'" >
							<div class="card">
